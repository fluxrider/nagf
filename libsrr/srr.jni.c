...
JNIEXPORT jobject JNICALL Java_Jsrr_init(JNIEnv * env, jclass _c, jstring jstring_name, jint length, jboolean is_server, jboolean use_multi_client_lock, jdouble timeout) {
...
JNIEXPORT jstring JNICALL Java_Jsrr_close(JNIEnv * env, jclass _c, jobject o) {
...
JNIEXPORT jobject JNICALL Java_Jsrr_get_1msg_1ptr(JNIEnv * env, jclass _c, jobject o) {
  struct opaque_data * data = (*env)->GetDirectBufferAddress(env, o);
  return (*env)->NewDirectByteBuffer(env, data->mem->msg, data->srr.length);
}

JNIEXPORT jobject JNICALL Java_Jsrr_get_1length_1ptr(JNIEnv * env, jclass _c, jobject o) {
  struct opaque_data * data = (*env)->GetDirectBufferAddress(env, o);
...
JNIEXPORT jstring JNICALL Java_Jsrr_reply(JNIEnv * env, jclass _c, jobject o, jint length) {
  struct opaque_data * data = (*env)->GetDirectBufferAddress(env, o);
